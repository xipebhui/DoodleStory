...
进入 `full_story_extract`：

- 推荐先对 H2 源样本 `7650413089900236066` 做全量故事提取，因为它风险更低，结构更稳定，且两个账号都能测试。
- 备选：如果想优先验证高转发规则梗，则先对 H1 源样本 `7649315939447871470` 做全量故事提取。

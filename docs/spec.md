...
0. 进入工作台。
   ...
   - 主工作台页面必须有稳定二级路径：任务页 `/tasks`、内容提取页 `/content-extractions`、风格页 `/styles`、角色管理页 `/characters`、管理员用户管理页 `/users`、管理员积分消耗页 `/credit-usage`、设置页 `/settings`、联系页 `/contact`。

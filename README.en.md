...
> 当前项目文档以中文维护。本文件保留用于兼容 README 链接。

DoodleStory 是一个文本转图片的故事生成项目。它会把用户输入的原始文本切分成一组画面片段，再结合风格库、风格提示词和风格绑定的图片模型生成多张图片。

## 产品形态

- 风格库：管理图片风格、参考图片、风格基础信息、风格提示词，以及该风格绑定的图片生成模型。
